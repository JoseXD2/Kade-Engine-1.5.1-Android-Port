			...
			case 'animeExpo':
				{
					...
					var characters1:FlxSprite = new FlxSprite(-550, 520);
					...
					var bar:FlxSprite = new FlxSprite(-570, 40).loadGraphic(Paths.image('Ethree/barra'));
			...
			case 'fireaaa':
				{
					...
					var deathfire:FlxSprite = new FlxSprite(1010, 550);
